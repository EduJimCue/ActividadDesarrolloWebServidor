...
using Clases;
    class Program{ 
        ...
        Leccion lesson= new Leccion("Karate nivel bajo",profe,"Clase de karate para principiantes",20,35,30);
        ...
        AllLessons.Add(lesson2);
            ...
            while (!repeat)
            {
                ...
                if (actual.Name!="")
                {
                    Console.WriteLine($"Hola {actual.Name} bienvenido de vuelta");
                }
                ...
                if (actual.Name!="")
                {
                Console.WriteLine($"Zona privada del usuario");
